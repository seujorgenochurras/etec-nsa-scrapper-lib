...
public class NsaSession {
   ...
   public Document getScheduleTimetableDocument(){
      return jsoupManager.getClassScheduleTimetablePage();
   }

   private record StudentTableService(NsaElement studentTableElement) {
